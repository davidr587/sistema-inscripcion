...
<?PHP 
  ...
  */
    ...
    if($boton=="Registrar"){
      ...
      $consulta="INSERT INTO  anoescolar (ano) 
        VALUES ('$ano')";
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            ...
            <h6>Registro de Años Escolares</h6>
                  <p class="text-sm mb-0">
                    <i class="fa fa-check text-info" aria-hidden="true"></i>
                    <span class="font-weight-bold ms-1">Años Escolar</span> Escuela Tecnica
                  </p> 
            <form role="form" class="text-start" method="post">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <label class="etiquetastec">Año Escolar</label>
                        <input type="text" class="form-control" name="ano" placeholder="Año Escolar" required  >
                    </div>
