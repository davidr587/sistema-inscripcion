...
<?PHP 
  ...
  */
    ...
    $boton=$_POST["boton"];
    $nomMencion =$_POST["nomMencion"];


    if($boton=="Registrar"){

      $consulta="INSERT INTO  mencion (nomMencion) 
        VALUES ('$nomMencion')";
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            ...
            <h6>Registro de Menciones</h6>
                  <p class="text-sm mb-0">
                    <i class="fa fa-check text-info" aria-hidden="true"></i>
                    <span class="font-weight-bold ms-1">Mención</span> Escuela Tecnica
                  </p> 
            <form role="form" class="text-start" method="post">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <label class="etiquetastec">Nombre de Mención</label>
                        <input type="text" class="form-control" name="nomMencion" placeholder="Nombre de la Mención" required onkeypress="return soloLetras(event)" >
                    </div>
