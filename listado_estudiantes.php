          ...
          <div class="card">
            ...
            <h6>Listado de Estudiantes</h6>
                  ...
                  include('conexion.php');
                    $var_consulta= "SELECT * FROM dataescolar WHERE ano LIKE '%$ano%'";
                    ...
                    if($var_resultado->num_rows>0)
                        ...
                        while ($var_fila=$var_resultado->fetch_array())
                        {
                            ...
                            echo "<td>".$var_fila["nomSeccion"]."</td>";
                            ...
                            echo "<td><a href='../reportes/planilla.php?cedulaEst=".$cedulaEst."' class='btn bg-gradient-primary w-100'><i class='material-icons opacity-10'>print</i></a></td></tr>";
                        }
                    }
                    else
                        {
